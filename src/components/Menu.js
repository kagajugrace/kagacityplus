...
<div className="w-full md:w-1/3 "><a href="/"><img src={logo}  className=" w-16 h-16"/></a></div>
<div className="navbar-container w-full md:w-2/3 text-right   text-underline hover:no-underline     py-4 hidden md:block">
...
<a href="/update" className="p-4 cursor-pointer  text-gray-900 hover:text-blue-700 font-bold text-md">COVID-19 Updates</a>
   ...
   {drop?
   <a className="float-right pt-20" onClick={handleclicked}><img src={close} className="w-10 h-10 ml-24" /></a>:<a className="float-right" onClick={handleclicked}><img src={menu} className="w-10 h-10 ml-24" /></a>}
</div>

    </nav>
    {drop?
    <div className="block md:hidden pt-20 shadow-lg text-center text-gray-700 hover:text-white text-underline hover:no-underline  text-xl font-bold ">
